...
train_step = tf.Variable(0) # global_step substitute
...
# Saving the model and the policy, and updating the checkpointer:
...
# Using the driver to play the game using updated model:
frames = []
